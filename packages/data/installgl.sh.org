...
echo $ipckey > $jaildir$glroot/ipckey.txt
export gl_ipckey
...
ExecStart=-$jaildir$glroot/bin/glftpd-full-static -l -o -i -e -I -n 0 -b -x -r $glroot/etc/glftpd.conf $glstrings
